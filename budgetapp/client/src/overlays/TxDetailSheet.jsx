...
export default function TxDetailSheet({ open, txId, txs, budgets, fmt, api, toast, onClose, onEdit, onDeleted }) {
      ...
      {tx && (
        <>
          ...
          <div className="card">
            ...
            <div className="tx-row" style={{ cursor: 'default', borderBottom: tx.notes ? undefined : 'none' }}>
